...
#include <reem_kinematics_constraint_aware/chainiksolvervel_pinv.hpp>

namespace KDL
{
    ChainIkSolverVel_pinvFo::ChainIkSolverVel_pinvFo(const Chain& _chain,double _eps,int _maxiter):
        chain(_chain),
        jnt2jac(chain),
    ...
    ChainIkSolverVel_pinvFo::~ChainIkSolverVel_pinvFo()
    {
    }


    int ChainIkSolverVel_pinvFo::CartToJnt(const JntArray& q_in, const Twist& v_in, JntArray& qdot_out)
    {
